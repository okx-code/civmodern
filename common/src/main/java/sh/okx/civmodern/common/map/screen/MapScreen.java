...
public class MapScreen extends Screen {
    ...
    /*addRenderableWidget(new ImageButton(10, 10, 20, 20, new ResourceLocation("civmodern", "gui/boat.png"), imbg -> {
      this.boating = !boating;
		...
		openWaypointButton = new ImageButton(this.width / 2 - 22, 10, 20, 20, new ResourceLocation("civmodern", "gui/boat.png"), imbg -> {
			waypointModal.setVisible(!waypointModal.isVisible());
		});
		addRenderableWidget(openWaypointButton);

		ImageButton targetButton = new ImageButton(this.width / 2 + 2, 10, 20, 20, new ResourceLocation("civmodern", "gui/target.png"), imbg -> {
