...
public final class IceRoadSettings {
    ...
    static @NotNull OptionGroup generateGroup(
        ...
        return OptionGroup.createBuilder()
            .name(Component.translatable("civianmod.config.group.iceRoad"))
            .collapsed(true)
    ...
    private static @NotNull Option<?> generateSnapPitch(
        ...
        return Option.<Boolean>createBuilder()
            .name(Component.translatable("civianmod.config.group.iceRoad.snapPitch"))
    ...
    private static @NotNull Option<?> generateSnapYaw(
        ...
        return Option.<Boolean>createBuilder()
            .name(Component.translatable("civianmod.config.group.iceRoad.snapYaw"))
            .controller(BooleanControllerBuilder::create)
            .binding(
                DEFAULT_SNAP_YAW,
    ...
    private static @NotNull Option<?> generateAutoEat(
        ...
        return Option.<Boolean>createBuilder()
            .name(Component.translatable("civianmod.config.group.iceRoad.autoEat"))
            .controller(BooleanControllerBuilder::create)
            .binding(
                DEFAULT_AUTO_EAT,
    ...
    private static @NotNull Option<?> generateStopWhenHungry(
        ...
        return Option.<Boolean>createBuilder()
            .name(Component.translatable("civianmod.config.group.iceRoad.stopWhenHungry"))
            .controller(BooleanControllerBuilder::create)
            .binding(
