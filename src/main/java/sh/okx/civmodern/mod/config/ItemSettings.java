...
public final class ItemSettings {
    ...
    private static @NotNull Option<?> generateCrateItemColour(
        ...
        return Option.<Color>createBuilder()
            .name(Component.translatable("civmodern.config.group.items.crateColour"))
            .description(OptionDescription.of(Component.translatable("civmodern.config.group.items.crateColour.desc")))
